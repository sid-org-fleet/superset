...
/**
 * Playwright equivalent of:
 *   cypress-base/cypress/e2e/explore/visualizations/shared.helper.js
 *
 * Shared constants and helpers for visualization E2E tests.
 */
 ...
 * Playwright equivalent of the Cypress `getDatasetId` helper.
 *
...
// ---------------------------------------------------------------
// Metric / filter column type definitions
// ---------------------------------------------------------------
...
export const SIMPLE_FILTER: SimpleFilter = {
  expressionType: 'SIMPLE',
  subject: 'name',
  operator: 'IN',
